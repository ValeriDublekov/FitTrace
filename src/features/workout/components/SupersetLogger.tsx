    ...
    >
      ...
      <div className="p-5 space-y-6">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-2 py-4 bg-slate-50 hover:bg-indigo-50/50 text-indigo-600 border border-slate-200 hover:border-indigo-200 rounded-2xl font-black text-[10px] uppercase tracking-widest transition-all active:scale-[0.98]"
        >
